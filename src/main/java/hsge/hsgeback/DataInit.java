...
public class DataInit {
    ...
    void init() {
        ...
        User user3 = User.builder().nickname("덴마크당나귀").longtitude(126.980193).latitude(37.5685019).role("user").email("eee@e.com").profilePath("wrewerrew").password("1234").build();
        User user4 = User.builder().nickname("모로코추파춥스").longtitude(126.980193).latitude(37.5685019).role("user").email("www@e.com").profilePath("wrewerrew").password("1234").build();
        User user5 = User.builder().nickname("핀란드브로콜리").longtitude(123.4).latitude(7521.2).role("user").email("qqq@e.com").profilePath("wrewerrew").password("1234").build();
        ...
        Pet pet2 = Pet.builder().breed(Breed.DACHSHUND).age(Age.FIFTEEN_YEARS).user(user1).gender("남").neutralization(false).petName("매운새우깡").description("매운새우깡.").likeTag("3대운동#웨이트#근성장").dislikeTag("유산소#호날두#비염").picture("https://user-images.githubusercontent.com/106398273/204183502-2974fadc-dae6-4238-83ce-3b4acd12373d.jpeg").build();
